...
namespace Translumo.MVVM.ViewModels
{
    public sealed class SettingsViewModel : BindableBase, IDisposable
    {
        ...
        public SettingsViewModel(DialogService dialogService, AppearanceSettingsViewModel appearanceVm, OcrSettingsViewModel ocrVm,
            LanguagesSettingsViewModel languagesVm, HotkeysSettingsViewModel hotkeysVm, LlmSettingsViewModel llmVm,
            SystemConfiguration systemConfiguration, ILogger<SettingsViewModel> logger)
        {
            ...
            AddNavigationItem(LocalizationManager.GetValue("Str.Navigation.Llm", false, OnLocalizedValueChanged, this), PackIconKind.RobotOutline, llmVm);
